...
- bootstrap helper: `scripts/bootstrap_ancap_docs_repo.py` for gh-driven public repo creation, repo settings, label, milestone, and later branch-protection payload application from the checked-in seeds once launch ownership/access exists
